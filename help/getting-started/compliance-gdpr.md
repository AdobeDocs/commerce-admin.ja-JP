...
- データフロー図とデータベースエンティティのマッピングについては、[個人情報参照](https://experienceleague.adobe.com/ja/docs/commerce-operations/security-and-compliance/reference/data-m2){: target="_blank"}を参照してください。
