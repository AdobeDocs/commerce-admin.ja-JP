...
1. **[!UICONTROL Continue]**&#x200B;をクリックします。
   ...
   この手順では、Adobe IDを作成し、現在のCommerce アカウント（MAGEID）にリンクします。 With this account link, the _[!UICONTROL Email]_field is blocked from any changes. 関連付けられたメールアドレスの設定は、Adobe ID アカウントから管理されます。
