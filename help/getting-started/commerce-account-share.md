...
>[!NOTE]
>
>このインターフェイスでは、MAG _XYZ[から共有名]_ Cloud Shared Accessのユーザーを削除することはできません。 [&#x200B; クラウドプロジェクトを介して共有アクセスが許可されたユーザーを削除する方法を参照してください。](https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/help-center-guide/magento-help-center-user-guide#remove-cloud-shared-access-users)。
