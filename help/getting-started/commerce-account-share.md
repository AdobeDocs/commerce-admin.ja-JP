...
>[!NOTE]
>
>_[!UICONTROL Security Tool]_へのアクセスを共有する必要はありません。MAGE IDを持つすべてのユーザーは、自分のアカウントでセキュリティスキャンツールを設定できます。 サイトに変更を加え、[必要なメソッド ](/help/systems/security-scan.md)）のいずれかを使用してドメインの所有権を検証するために必要な権限だけが必要です。
