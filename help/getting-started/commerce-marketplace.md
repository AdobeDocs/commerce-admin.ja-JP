...
[!DNL Commerce Marketplace] から購入した拡張機能をインストールする前に、[!DNL Commerce] アカウントにサインインし、アクティブなアクセスキーがあることを確認します。 [!DNL Commerce] または [[!DNL Marketplace]][1]Magento.com[ のヘッダーから ][6] アカウントにログインできます。
