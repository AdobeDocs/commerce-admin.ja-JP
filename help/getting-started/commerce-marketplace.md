...
[!DNL Commerce Marketplace]から購入した拡張機能をインストールする前に、[!DNL Commerce] アカウントにサインインし、アクティブなアクセスキーがあることを確認してください。 [!DNL Commerce][[!DNL Marketplace]または](https://marketplace.magento.com/)Magento.com[のヘッダーから](https://business.adobe.com/products/magento/magento-commerce.html) アカウントにログインできます。
...
1. _[!UICONTROL Marketplace]_の「_[!UICONTROL My Products]_」タブで、「**[!UICONTROL Access Keys]**」をクリックし、次のいずれかの操作を行います。
