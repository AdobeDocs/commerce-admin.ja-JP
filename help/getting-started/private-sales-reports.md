...
description: Adobe Commerceのプライベートセールスレポートでは、イベントやプライベートセールスに関する有益な情報を提供します。
...
個人向け販売レポートには、[件のイベントと個人向け販売](../merchandising-promotions/events-private-sales.md)に関する情報が記載されています。
