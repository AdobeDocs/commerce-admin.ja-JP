...
（Adobe Commerceのみ） [[!DNL Site-Wide Analysis Tool]](https://experienceleague.adobe.com/en/docs/commerce-operations/tools/site-wide-analysis-tool/access)は、クラウド インフラストラクチャ上のAdobe Commerceのインストールに関するシステム インサイトを、24時間年中無休のリアルタイム パフォーマンス監視、レポート、および推奨事項とともに提供します。
