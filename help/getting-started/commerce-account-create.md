...
[最初のチケット &#x200B;](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide#support-case)を送信する必要がある場合、またはAdobe Commerce リレーションシップを管理する必要がある場合は、[!DNL Commerce] アカウントを作成またはアクセスすることから始めます。
