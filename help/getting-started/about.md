...
[Adobe CommerceのEdge Delivery Services](https://experienceleague.adobe.com/developer/commerce/storefront/) は、コンテンツ作成と顧客体験の両方で優れたエクスペリエンスを提供することでビジネス価値を高める、構成可能なサービスのセットです。 ドキュメントベースのコンテンツオーサリングや組み込みの A/B テストなどのビジネスベースの機能と、コマースのコア機能を提供するAdobe Commerce ドロップコンポーネントを組み合わせています。 これらの機能はすべてエッジから提供されるので、非常に高速なストアフロント体験が実現します。
...
また、コンテンツ制作コストを削減することで、ビジネスコンテンツの所有者がストアフロントの経験をすばやく簡単に磨き、コマース管理者がCommerceの統合機能を提供することができるため、このメリットも得られます。 共同作業チームの運用上の障害はなくなりました。

これらはすべて、コンポーザブルなアーキテクチャを通じて実現されます。コンテンツ管理システム（CMS）と公開機能をAdobe Commerceのドロップコンポーネントと組み合わせることで、真に柔軟なCommerce ストアフロントを構築します。 Adobeは、商品のリストページ、商品の詳細ページ、新しい 1 ステップのチェックアウトドロピンなど、ドロピンとして様々なコアコマース機能を提供します。これにより、プラグアンドプレイ方式で顧客のジャーニーにシームレスなチェックアウトエクスペリエンスを追加できます。 お客様は、既存のテクノロジと組み合わせて、ストアフロントの主要な部分にEdge Delivery Servicesを使用し始め、そこから時間をかけて拡張することができます。

その結果、コンテンツ作成チームの速度、顧客にコンテンツを配信する速度、新しいエクスペリエンス駆動型の高性能なストアフロントを通じて顧客がデジタルでどのような関与をするかを示す速度が得られます。
...
これにより、Experience Manager Assets Cloud Serviceを、アセットの作成と管理のための唯一の情報源として、また、Adobe Commerceを強化する一元化された DAM として使用して、アセットのスケーラビリティを新たな高みに引き上げることができます。

新しいルールエンジンサービスは、Experience Manager Assets戦略に応じて、SKU や他の主要な属性に基づいて、Adobe Commerceで一致した製品にCommerceのアセットをフィードします。 更新は自動的に共有されるので、サイトには最新の製品アセットとアセットバリエーションが用意されます。

Experience Manager Assetsの GenAI サービスを使用して数百万もの商品アセットのバリエーションを生成することで、カスタマーエクスペリエンスをパーソナライズし、新製品のローンチ、市場の拡大、季節的なキャンペーンをサポートし、速度を向上させます。
...
最新のリリースは、2023 年の一連のアップデートに基づいており、Apple Pay との統合により、不正対策、英国とフランスの国際的なサポート、企業規模のインフラストラクチャ拡張、取引レポートが追加されました。 新しい機能は、支払いオプションを拡張し、ストアフロントテクノロジーが使用されていても、開始を容易にします。
...
支払いサービスには、マーチャントがAdobe Experience Managerやその他のカスタムフロントエンドなどのヘッドレスストアフロント実装で支払いを受け入れ、処理できるように、GraphQLがサポートされるようになりました。
...
今年、Adobeは以下を含むさらに多くのデータを共有する予定である [Commerce顧客プロファイル](https://experienceleague.adobe.com/en/docs/commerce-admin/customers/customer-accounts/manage/update-account)、モバイルアプリの動作、バックオフィスイベントのカスタム属性を使用して、キャンペーンとエクスペリエンスを大幅にパーソナライズできます。
...
#### コマースデータを使用して、Adobe Journey Optimizer内の買い物かごメールを破棄する
...
また、Adobeは、最新性、頻度、収益化レポートなど、Commerce固有のダッシュボードをAdobe Experience Platformで追加して、マーケターがCommerce データを分析し、セグメント化戦略とパーソナライゼーションの機会を特定できるようにしています。
...
Adobeはこれらを拡大しました [Audience Activation](https://experienceleague.adobe.com/en/docs/commerce-admin/customers/audience-activation) マーケターやマーチャンダイザーがAdobeのReal-Time CDPで定義されたオーディエンスを使用して、Adobe Commerceのショッピングエクスペリエンスのより多くの側面をパーソナライズできる機能。以下に例を示します [関連する製品ルール](https://experienceleague.adobe.com/en/docs/commerce-admin/marketing/promotions/product-relationships/product-related-rules) に加えて、アップセルおよびクロスセルのレコメンデーション用 [プロモーション](https://experienceleague.adobe.com/en/docs/commerce-admin/marketing/promotions/cart-rules/price-rules-cart) および [コンテンツブロック](https://experienceleague.adobe.com/en/docs/commerce-admin/content-design/elements/dynamic-blocks/dynamic-blocks).

#### ネイティブモバイルアプリでのコマースの追跡とパーソナライズ

また、Adobeは、高度にパーソナライズされたエクスペリエンスをモバイルアプリコマースにも提供しています。 使用 [データ接続](https://experienceleague.adobe.com/en/docs/commerce-merchant-services/data-connection/overview)を使用すると、Adobe Commerceから他のAdobe Experience Cloud アプリケーション（Adobe Real-Time CDP、Adobe Journey Optimizer、Customer Journey Analytics、Adobe Analytics、Adobe Targetなど）にモバイルアプリイベントを送信できます。 使用 [Audience Activation](https://experienceleague.adobe.com/en/docs/commerce-admin/customers/audience-activation)を使用すると、Adobe Real-Time CDP内で作成および管理されるオーディエンスに基づいて、動的コンテンツ、プロモーション、関連する製品ルールなどのモバイルアプリエクスペリエンスをパーソナライズできます。
...
>- パーソナライゼーションジャーニーを開始し、一般的なパーソナライゼーションのユースケースについて詳しくは、 [大規模なパーソナライゼーションドキュメント](https://experienceleague.adobe.com/en/docs/commerce-admin/customers/customers-menu/personalize-scale).

Adobe CommerceのAdobe Journey Optimizerとのデータ接続および Real-time CDP を使用して、パーソナライズされたショッピングエクスペリエンスを大規模に作成するコカコーラのデジタルトランスフォーメーションジャーニーについて説明します。 [コカコーラ：データをロック解除して、コンシューマー中心のCommerce エクスペリエンスを作成する](https://business.adobe.com/summit/2024/sessions/cocacola-unlocking-data-to-create-consumercentric-s434.html).
...
- 包括的 [API](https://developer.adobe.com/commerce/webapi/) を使用したカバレッジと API オーケストレーション [API メッシュ](https://developer.adobe.com/graphql-mesh-gateway/)
- [Webhook](https://developer.adobe.com/commerce/extensibility/webhooks/) 買い物かごに追加やチェックアウトなどのネイティブのコマースプロセスをカスタマイズするには
- Commerceを拡張するための詳細なコントロール [管理 UI](https://developer.adobe.com/commerce/extensibility/admin-ui-sdk/) カスタム商社機能の場合
- 七百をこえる場合 [イベント](https://experienceleague.adobe.com/en/docs/commerce-learn/tutorials/adobe-developer-app-builder/io-events/getting-started-io-events) スケーラブルなイベント駆動型統合を構築する
...
e コマースプラットフォームを ERP、OMS、または CRM と統合することは、ミッションクリティカルな要件です。 企業は、こうした統合の構築に数万ドルを費やすことができます。 Adobeは、バックオフィスシステムとの統合のコストを削減し、リアルタイム接続の信頼性を高めるために、を提供しています [統合スターターキット](https://developer.adobe.com/commerce/extensibility/starter-kit/create-integration/) （Adobe Commerceの場合）

このキットには、注文、製品、顧客など、一般的に使用されるコマースデータの参照統合が含まれています。  また、オンボーディングスクリプトや、開発者が次のベストプラクティスに基づいて構築するための標準化されたアーキテクチャも含まれています。 このスターターキットは、統合作業を最大 50% 削減することが期待されています。 これらの参照統合は、開発者がビジネスニーズに合わせて簡単にカスタマイズでき、市場投入までの時間と統合のコストを削減できます。

2024 年 6 月に、Adobeは、この統合スターターキットを使用して構築された最初の ERP 統合アクセラレーターをリリースします [Microsoft Dynamics Finance &amp; Operations](https://www.microsoft.com/en-us/dynamics-365/products/finance). Microsoftの ERP 向けのこの Integration Accelerator を使用して、注文の処理、商品データと顧客レコードの更新、Microsoft Dynamics Finance &amp; Operations とAdobe Commerceの在庫レベルの同期を行うことができます。 Microsoft Dynamics Finance &amp; Operations アクセラレーターは、 [Commerce Marketplace](https://commercemarketplace.adobe.com/).
...
- 一括 [import](https://developer.adobe.com/commerce/webapi/rest/modules/import/) json 形式では 1 分あたり最大 100,000 件のレコード。
