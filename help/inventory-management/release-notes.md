...
サポートされているリリースと互換性のあるリリースについては、[ リリーススケジュール ](https://experienceleague.adobe.com/en/docs/commerce-operations/release/planning/schedule){target="_blank"}を参照してください。
