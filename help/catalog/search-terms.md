...
- ライブサーチ [同義語](https://experienceleague.adobe.com/en/docs/commerce/live-search/live-search-admin/synonyms/synonyms)機能は、ライブサーチがインストールされたAdobe Commerce インストールで使用できます。
