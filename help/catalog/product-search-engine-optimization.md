...
1. 下にスクロールして、_[!UICONTROL Search Engine Optimization]_セクションの![拡張セレクター](../assets/icon-display-expand.png)を展開します。
