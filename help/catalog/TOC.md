...
user-guide-description: Adobe CommerceとMagento Open Sourceの管理者およびe コマースマーケター向けのカタログ管理機能に関する包括的な情報を提供します。
...
+ カタログの基本 {#catalog}
  ...
  + カタログナビゲーション {#navigation}
    ...
    + [階層化されたナビゲーション](navigation-layered.md)
  + カタログ検索 {#search}
    + [検索の概要](search.md)
...
+ カテゴリ {#categories}
  ...
  + カテゴリの作成と更新 {#create}
    ...
    + [検索エンジン最適化の設定](categories-search-engine-optimization.md)
  ...
  + [予定された変更](category-scheduled-changes.md)
  + [カテゴリの権限](category-permissions.md)
+ 特定可能 {#products}
  + [製品リスト](products-list.md)
  + [製品ワークスペース](product-workspace.md)
  + [製品の作成](product-create.md)
  + 製品タイプ {#types}
    + [簡易商品](product-create-simple.md)
    + [コンフィグ商品](product-create-configurable.md)
  ...
  + 製品デジタルアセット {#digital-assets}
    + [カタログの画像とビデオ](catalog-images-video.md)
    + [画像アセット設定](product-image-config.md)
    + [商品画像の管理](product-image.md)
    + [製品ビデオを追加](product-video.md)
    + 製品3D モデルの管理 {#product-3d-model}
      + [AR Viewerの概要](ar-viewer-overview.md)
      + [AR ビューアの設定](ar-viewer-setup.md)
  + 価格の管理 {#pricing}
    + [価格範囲](catalog-price-scope.md)
    + [詳細な価格設定](pricing-advanced.md)
  ...
  + [製品アップデートのスケジュール](product-scheduled-changes.md)
  + 製品設定リファレンス {#settings}
    + [ソース](sources.md)
