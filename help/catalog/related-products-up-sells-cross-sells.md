...
><br/>>このAdobeで開発した拡張機能を、手動で設定した商品レコメンデーションやアップセルの代わりに使用する方法について詳しくは、_[商品レコメンデーションガイド ](https://experienceleague.adobe.com/docs/commerce/product-recommendations/guide-overview.html)_&#x200B;を参照してください。
