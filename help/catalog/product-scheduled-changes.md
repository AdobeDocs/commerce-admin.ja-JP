...
_[!UICONTROL Schedule Design Update]_&#x200B;セクションでは、製品ページの外観を一時的に変更することができます。 デザインの変更は、シーズンやプロモーションだけでなく、新鮮なコンテンツを制作するためにも利用できます。 デザインの変更は事前にスケジュールできるので、定義済みのスケジュールに従って有効または_ ドリップ _になります。
