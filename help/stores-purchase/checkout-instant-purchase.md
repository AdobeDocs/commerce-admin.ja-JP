...
- [決済サービスのドキュメント](https://experienceleague.adobe.com/docs/commerce/payment-services/guide-overview.html?lang=ja)

### ステップ 3：即時購入を有効にする

1. _[!UICONTROL Sales]_&#x200B;セクションの下の左側のパネルで、**[!UICONTROL Sales]**&#x200B;を選択します。
