...
- [USPS REST API 移行品質パッチ &#x200B;](https://experienceleague.adobe.com/ja/docs/commerce-operations/tools/quality-patches-tool/patches-available-in-qpt/v1-1-70/ac-15210) を適用して、USPS REST API との統合のサポートを追加します。
