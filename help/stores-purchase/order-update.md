...
| **[!UICONTROL Hold]** / **[!UICONTROL Unhold]** | 保留中の注文のステータスを`On Hold`に変更します。 保留を解除するには、_[!UICONTROL Unhold]_&#x200B;を選択します。 |
...
| **[!UICONTROL Hold]** / **[!UICONTROL Unhold]** | 販売注文のステータスを`On Hold`に変更します。 販売注文の保留を解除するには、_[!UICONTROL Unhold]_&#x200B;を選択します。 |
