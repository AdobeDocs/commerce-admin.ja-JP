...
- [Marketplace の不正防止ソリューション &#x200B;](https://marketplace.magento.com/catalogsearch/result?q=fraud%20protection)
...
支払いに関する問題のトラブルシューティングについて詳しくは、[&#x200B; サポートナレッジベース &#x200B;](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/overview.html) を参照してください。
