...
+ 顧客管理ツール {#customers-menu}
   ...
   + [オンラインに移行](now-online.md)
   + [Personalizationの大量運用](personalize-scale.md)
+ 顧客アカウント {#customer-accounts}
   + [アカウントスコープ](customer-account-scope.md)
   ...
   + ストアクレジット {#store-credit}
      ...
      + [ストアクレジットを設定](credit-configure.md)
      + [ストアクレジットを適用](store-credit-using.md)
