...
description: 顧客ダッシュボードの[!UICONTROL My Account] ページでは、ストアに関連する情報とアクティビティの概要が顧客に表示されます。
...
顧客ダッシュボードの&#x200B;**[!UICONTROL My Account]** ページでは、ストアに関連する情報とアクティビティの概要が顧客に表示されます。
