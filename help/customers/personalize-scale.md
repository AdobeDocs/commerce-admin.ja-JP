...
- Adobe [!DNL Commerce]で買い物かごの価格ルールを通知するために、[Real-Time CDP](https://experienceleague.adobe.com/ja/docs/commerce/data-connection/use-cases/create-audience)でオーディエンスを作成する方法について説明します。
