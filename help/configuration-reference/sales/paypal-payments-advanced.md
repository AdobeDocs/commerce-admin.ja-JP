...
description: Commerce管理者の[!UICONTROL Sales] > [!UICONTROL Payment Methods] ページの[!UICONTROL PayPal Payments Advanced] セクションの設定を確認します。
...
>
>**PSD2の要件：** <br/>
>2019年9月14日の時点で、ヨーロッパの銀行は[PSD2](../../getting-started/compliance-payment-services-directive.md)の要件を満たさない支払いを拒否する可能性があります。PSD2に準拠するには、[!DNL PayPal Payments Advanced]を[!DNL Cardinal Commerce]と統合する必要があります。詳しくは、「[3-D Secure for Payflow](https://developer.paypal.com/api/nvp-soap/payflow/3d-secure-overview/)」を参照してください。

{{config}}

## [!UICONTROL Required Settings]

![必要な設定](./assets/payment-methods-paypal-payments-advanced-required.png)<!-- zoom -->
...
| [!UICONTROL Test Mode] | web サイト | 有効にすると、テスト環境でPayPal Payments Advancedを実行します。 実稼動モードで「本番稼動」する準備ができたら、テストモードをオフにします。 オプション：`Yes` / `No` |
...
| [!UICONTROL Enable this Solution] | web サイト | PayPal Payments Advancedがお客様の支払い方法として利用可能かどうかを決定します。 |
...
| フィールド | [範囲](../../getting-started/websites-stores-views.md#scope-settings) | 説明 |
|--- |--- |--- |
| [!UICONTROL Title] | ストアビュー | チェックアウト時の支払い方法としてPayPal Payments Advancedを識別する名前。 |
| [!UICONTROL Sort Order] | ストアビュー | チェックアウト時に他の支払い方法と共に表示されるPayPal支払い詳細の順序を決定する番号。 |
