...
description: Commerce管理者の[!UICONTROL Sales] > [!UICONTROL PDF Print-outs] ページで設定を確認します。
...
|--- |--- |--- |
| [!UICONTROL Display Order ID in Header] | ストアビュー | 参照用に請求書のヘッダーに注文IDを含めます。 オプション：`Yes` / `No` |
...
| フィールド | [範囲](../../getting-started/websites-stores-views.md#scope-settings) | 説明 |
|--- |--- |--- |
| [!UICONTROL Display Order ID in Header] | ストアビュー | 参照用に出荷梱包明細のヘッダーに注文IDを含めます。 オプション：`Yes` / `No` |
...
| フィールド | [範囲](../../getting-started/websites-stores-views.md#scope-settings) | 説明 |
|--- |--- |--- |
| [!UICONTROL Display Order ID in Header] | ストアビュー | 参照用のクレジットメモのヘッダーに注文IDを含めます。 オプション：`Yes` / `No` |
