...
| [!UICONTROL Manifest MID] | Web サイト | REST API のマニフェスト用に指定された一意のメーラー識別子。  <br/><br/>**_Note:_** このフィールドはオプションですが、出荷ラベルの作成を有効にするために必須です。 |
