...
>
>**PSD2の要件：**<br/>
>2019年9月14日現在、ヨーロッパの銀行は[PSD2](../../getting-started/compliance-payment-services-directive.md)の要件を満たさない支払いを拒否する可能性があります。 すべての要件はPayPalによって処理されるため、[!DNL PayPal Payments Standard]がPSD2に準拠するために何もする必要はありません。
