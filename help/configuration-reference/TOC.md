...
user-guide-description: このガイドでは、**[!UICONTROL Stores]** > _[!UICONTROL Settings]_ > **[!UICONTROL Configuration]**の_Admin_ サイドバーからアクセスされるすべてのストア構成設定に関する参照情報を提供します。
...
- カタログ {#catalog}
   ...
   - [友達にメール](./catalog/email-to-a-friend.md)
   - [製品ファイル属性](./catalog/product-file-attributes.md)
- セキュリティ {#security}
   - [2FA](./security/2fa.md)
   - [Google reCAPTCHA管理パネル](./security/google-recaptcha-admin.md)
...
- 営業担当者 {#sales}
   ...
   - お支払い方法 {#payment-methods}
      ...
      - [決済サービス](./sales/payment-services.md)
