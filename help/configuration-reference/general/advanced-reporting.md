...
_[!DNL Advanced Reporting]_&#x200B;は、[Adobe Commerce Intelligence](https://experienceleague.adobe.com/docs/commerce-business-intelligence/mbi/getting-started.html?lang=ja){:target="_blank"} を利用したクラウドベースのサービスです。 詳細については、「[&#x200B; はじめる前に &#x200B;](https://experienceleague.adobe.com/docs/commerce-admin/start/reporting/business-intelligence.html?lang=ja#advanced-reporting){:target="_blank"}」の_ 詳細レポート _を参照してください。
