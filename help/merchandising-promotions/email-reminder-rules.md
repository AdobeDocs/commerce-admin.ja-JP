...
1. ![&#x200B; のセクションの &#x200B;](../assets/icon-display-expand.png) 展開セレクター **[!UICONTROL Automated Email Reminder Rules]** を展開し、以下を実行します。
   ...
   - **[!UICONTROL Interval]** の設定に基づいて、適切な _[!UICONTROL Frequency]_&#x200B;を設定します。
   ...
   - リマインダーメールの送信者として表示される **[!UICONTROL Reminder Email Sender]** 店舗連絡先 [&#x200B; に &#x200B;](../getting-started/store-details.md#store-email-addresses) を設定します。
...
1. **[!UICONTROL Template]** の下の `Magento_Reminder` リストで、**[!UICONTROL Promotion Notification/Reminder]** テンプレートを選択します。
