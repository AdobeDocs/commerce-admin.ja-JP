...
1. 「_デフォルトのタイトルと説明_」セクションで、次の操作を行います。
   ...
   - _[!UICONTROL Titles and Descriptions Per Store View]_セクションで、**[!UICONTROL Rule Title]**デフォルトのストアビュー&#x200B;**[!UICONTROL Description]**の_&#x200B;と&#x200B;_を入力します。 複数のストアビューの場合は、それぞれに適切なタイトルと説明を入力します。
