...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p><a href="https://experienceleague.adobe.com/en/docs/commerce-admin/systems/tools/index-management"> カスタマーグリッドインデクサー </a> のデフォルトモードを明確にしました。これは 2.4.8 で変更されました。</p>
</td>
      <td>
        技術
      </td>
