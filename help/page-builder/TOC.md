...
user-guide-description: ' [!DNL Page Builder] 機能を使用して、ビジュアル storytellingを強化し、顧客エンゲージメントとロイヤルティを促進するカスタムレイアウトを使用した、豊富なコンテンツを持つページを作成する方法について説明します。'
...
- [設定と設定](setup.md)
- チュートリアル {#walkthrough}
   - [パート 1：シンプルなページ](1-simple-page.md)
   - [パート 2：ブロック](2-blocks.md)
   - [パート 3：カタログコンテンツ](3-catalog-content.md)
...
- コンテンツを追加 {#add-content}
   ...
   - [特定可能](products.md)
   - [商品レコメンデーション](recommendations.md)
- [テンプレート](templates.md)
