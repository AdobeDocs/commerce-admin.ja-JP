...
1. _[!UICONTROL Entity Attributes]_で、下にスクロールするか、属性ラベルフィルターを使用して&#x200B;**[!UICONTROL SKU]**属性を見つけ、次の操作を行います。
...
1. _[!UICONTROL File to Import]_で、**[!UICONTROL Choose File]**をクリックし、インポート用に準備したCSV ファイルに移動して、ファイルを選択します。
