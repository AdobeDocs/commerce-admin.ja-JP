...
|  | `Sales Channel` | [`Amazon Sales Channel`](https://experienceleague.adobe.com/ja/docs/discontinued/using/commerce-channels) |
...
|  | `System Insights` ![Adobe Commerce](../assets/adobe-logo.svg) | [`Site-Wide Analysis Tool`](https://experienceleague.adobe.com/ja/docs/commerce-operations/tools/site-wide-analysis-tool/access) |
