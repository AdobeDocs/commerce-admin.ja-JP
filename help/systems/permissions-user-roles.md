...
1. **[!UICONTROL Resource]** ツリー構造で、役割がアクセスできる各管理者機能のチェックボックスを選択します。
   ...
   >[!NOTE]
   >
   >**[!UICONTROL Sales / Archive]**、_[!UICONTROL Invoices]_および_[!UICONTROL Credit Memos]_&#x200B;件の順序&#x200B;_[!UICONTROL Shipments]_タブ [を表示するには、管理者ユーザーが役割の範囲に対して](../stores-purchase/order-processing.md)権限を持っている必要があります。
