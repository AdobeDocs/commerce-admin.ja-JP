...
1. 設定するストアビューを見つけ、**[!UICONTROL Edit]**&#x200B;列の&#x200B;_[!UICONTROL Action]_をクリックします。

1. _[!UICONTROL Other Settings]_で、![ セクションの](../assets/icon-display-expand.png)拡張セレクター&#x200B;**[!UICONTROL Transactional Emails]**を展開します。
