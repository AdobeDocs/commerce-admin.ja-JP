...
>[!NOTE]
>
>[!DNL Adobe Commerce as a Cloud Service] プラットフォームでは、アクションログレポート、アクションログアーカイブ、バルクアクションログを設定できませんが、管理者の&#x200B;**[!UICONTROL System]** > _[!UICONTROL Action Logs]_&#x200B;メニューからレポート出力を確認できます。
