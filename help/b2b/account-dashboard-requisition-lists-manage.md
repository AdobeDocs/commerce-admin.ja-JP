...
description: アカウントダッシュボードで利用できる購買リストの顧客体験について説明します。
...
1. **[!UICONTROL Add to Cart]**&#x200B;をクリックします。
   ...
   ![要求リストの詳細](./assets/requisition-list-view.png){width="700" zoomable="yes"}
...
1. 出力デバイスを確認し、**[!UICONTROL Print]**&#x200B;をクリックします。
   ...
   ![購買依頼リストを印刷](./assets/requisition-list-print.png){width="500" zoomable="yes"}
...
1. **[!UICONTROL Save]**&#x200B;をクリックします。
   ...
   ![ リクエストリスト名を変更](./assets/requisition-list-rename.png){width="300"}
...
| [!UICONTROL Select] | アクションの対象となる項目の選択を管理します。<br/>**[!UICONTROL Select All]**– 購買リストのすべての項目を選択します。<br/>**[!UICONTROL Remove Selected]** – 選択したすべての項目を購買リストから削除します。<br/>**[!UICONTROL Copy Selected]**– 選択したすべての項目を別の購買リストにコピーします。 |
...
![ ページネーション付き購買依頼リスト ](./assets/requisition-list-bottom-with-pagination.png){width="700" zoomable="yes"}

>[!NOTE]
>
> 注意が必要な製品（在庫切れなど）がページネーションの現在のページ内に含まれる場合は、リストの上部に表示されます。注意が必要な製品の数は、リストの上に表示されます。
> ![注意が必要な項目](./assets/requisition-list-product-requiring-attention.png){width="500"}

### ストアフロントのページネーション制御

| 制御 | 説明 |
|----------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![ ページごとに表示](./assets/control-pagination-show-per-page.png) | [!UICONTROL Show Per Page] - 1 ページあたりの購買リスト項目の数を指定します。 20、50、100、500、または1000の購買リスト項目を選択して、ページに表示できます。 |
| ![ ページネーション リンク ](./assets/control-pagination.png) | [!UICONTROL Pagination links] – 他のページへのナビゲーションリンクを提供します。 |