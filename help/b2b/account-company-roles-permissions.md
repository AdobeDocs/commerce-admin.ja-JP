...
デフォルトの役割![を持つ](./assets/company-roles-permissions.png){width="700" zoomable="yes"}役割と権限ページ
...
1. 変更する役割を見つけ、**[!UICONTROL Edit]**&#x200B;列の&#x200B;**[!UICONTROL Actions]**&#x200B;をクリックします。
...
1. 複製する役割を見つけ、**[!UICONTROL Duplicate]**&#x200B;列の&#x200B;**[!UICONTROL Actions]**&#x200B;をクリックします。
...
1. **[!UICONTROL Delete]**&#x200B;列の&#x200B;**[!UICONTROL Actions]**&#x200B;をクリックします。
...
| View Approval Rules | 発注書の承認ルールを表示します。 |
